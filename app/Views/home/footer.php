<footer class="footer">
    ...
    <!-- Core JavaScript
    ================================================== -->
    <script src="http://news.test/front/js/jquery.min.js"></script>
    <script src="http://news.test/front/js/tether.min.js"></script>
    <script src="http://news.test/front/js/bootstrap.min.js"></script>
    <script src="http://news.test/front/js/custom.js"></script>
