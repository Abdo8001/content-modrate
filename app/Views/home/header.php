...
<head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="http://news.test/front/css/bootstrap.css" rel="stylesheet">

    <!-- FontAwesome Icons core CSS -->
    <link href="http://news.test/front/css/font-awesome.min.css" rel="stylesheet">

    <!-- Custom styles for this template -->
    <link href="http://news.test/front/css/style.css" rel="stylesheet">

    <!-- Responsive styles for this template -->
    <link href="http://news.test/front/css/responsive.css" rel="stylesheet">

    <!-- Colors for this template -->
    <link href="http://news.test/front/css/colors.css" rel="stylesheet">
        ...
        <div class="header-section">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="logo">
                            <a href="<?=CSS_PATH?>user/dashbord"><img src="<?=CSS_PATH?>front/images/logo.png" alt=""></a>
                        </div><!-- end logo -->
                    </div>
                </div><!-- end row -->
            </div><!-- end header-logo -->
