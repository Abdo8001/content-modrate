...
<head>
    ...
    <link rel="stylesheet" href="<?=CSS_PATH?>website/sky/css/external/slick.css">
    <link rel="stylesheet" href="<?=CSS_PATH?>website/sky/css/external/all.min.css">
    <link rel="stylesheet" href="<?=CSS_PATH?>website/sky/css/external/bootstrap.min.css">
    <link rel="stylesheet" href="<?=CSS_PATH?>website/sky/css/external/dscountdown.css">
    <link rel="stylesheet" href="<?=CSS_PATH?>website/sky/css/style.css">
...
<body>
    ...
    <script src="<?=CSS_PATH?>website/sky/j.s/External/jquery-3.5.1.js"></script>
    <script src="<?=CSS_PATH?>website/sky/j.s/External/popper.min.js"></script>
    <script src="<?=CSS_PATH?>website/sky/j.s/External/bootstrap.min.js"></script>
    <script src="<?=CSS_PATH?>website/sky/j.s/External/slick.min.js"></script>
    <script src="<?=CSS_PATH?>website/sky/j.s/External/dscountdown.min.js"></script>
    <script src="<?=CSS_PATH?>website/sky/j.s/main.js"></script>
</body>
</html>